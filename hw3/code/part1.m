function [images_set_1, sift_matches_1, sift_scores_1, points_1, images_set_2, sift_matches_2, sift_scores_2, points_2] = part1(images_per_set)
    ...
    [images_set_1, sift_matches_1, sift_scores_1, points_1] = match_set(images, masks, 1, 1 + images_per_set);
    [images_set_2, sift_matches_2, sift_scores_2, points_2] = match_set(images, masks, 5, 5 + images_per_set);
