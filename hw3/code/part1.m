function part1()
    ...
    [images_set_1, sift_matches_1, sift_scores_1] = match_set(images, 1, 5);
    [images_set_2, sift_matches_2, sift_scores_2] = match_set(images, 5, 9);
    save('sift_set_1.mat', 'images_set_1', 'sift_matches_1', 'sift_scores_1');
    save('sift_set_2.mat', 'images_set_2', 'sift_matches_2', 'sift_scores_2');
end